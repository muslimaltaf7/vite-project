...
const MQL = () => {
  return (
    <div className="container sm:w-[80%] w-[90%] mx-auto px-1 py-28">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
        ...
        <div className='flex flex-col items-center justify-center'>
          ...
          <div className=" text-[#05195F]  flex sm:flex-row  sm:gap-6 items-center justify-between md:justify-between">
