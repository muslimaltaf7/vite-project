...
const Hero = () => {
  return (
    <div className="grid lg:grid-cols-2 md:grid-cols-2 items-center w-[80%] mx-auto font-poppins">
      <div className=" md:text-left flex flex-col gap-4 col-span-1">
        ...
        <h1 className="text-[46px] text-[#05195F] font-semibold  md:leading-relaxed" >
        ...
        <button className="bg-[#CC0047] font-semibold text-[18px] md:text-xl text-white py-2 px-8 md:px-12 rounded-full w-fit">
          Get Started
        </button>
      </div>
