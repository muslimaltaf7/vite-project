...
const Hero = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8 mt-14"> {/* Adjusted margin-top value */}
      <div className="text-center md:text-left space-y-4">
        <h4 className="text-[#0066FC] font-bold text-[24px] font-poppins">
          <strong>Content Syndication</strong>
        </h4>
        <h1 className="text-[50px] font-lg font-bold text-[#05195F] leading-relaxed">
          Get leads that <br /> convert with content <br /> syndication.
        </h1>
