...
const Footer = () => {
  return (
    <div className="flex flex-1 flex-col space-x-10 flex-wrap md:flex-row w-full lg:flex-row sm:flex-row bg-cover h-[907.88px] bg-no-repeat bg-center  bg-[url('images/footer-bg.webp')] py-24 px-20 text-white">
