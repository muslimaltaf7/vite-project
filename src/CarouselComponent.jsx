...
const CarouselComponent = () => {
    ...
    return (
        ...
        <div className="w-4/5 mx-auto relative">
            ...
            <div className="bg-[#F8F8F8]"> {/* Apply background color to immediate parent of Slider */}
                <Slider {...settings}>
